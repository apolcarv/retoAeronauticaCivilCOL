...
public class ValidarDescargaDelArchivo implements Question {
    @Override
    ...
    public static ValidarDescargaDelArchivo validacionExitosa(){
        return new ValidarDescargaDelArchivo();
    }
}
